...
const ContactUs = () => {
  return (
    <div>
      ...
      <div className="lg:px-30 px-5 mt-4">
        <p className="text-md text-gray-600">
          <Link to="/home" className="hover:text-pink-600">Home</Link> / ContactUs
        </p>
      </div>

      <div className='lg:pl-35 px-5 pt-10 lg:pt-15 flex flex-col lg:flex-row lg:justify-between gap-10'>
        ...
        <div className='lg:mr-64 lg:pr-10 w-full lg:w-auto'>
          ...
          <a href="#" className='mt-4 text-blue-600 hover:underline break-all'>
